 ...
 *           therefore the pregnancyId would be related to these changes since they need to
 *           be identified when sending to server on sync.
...
internal data class PatientAndReadings(
    @Embedded
    val patient: Patient,
