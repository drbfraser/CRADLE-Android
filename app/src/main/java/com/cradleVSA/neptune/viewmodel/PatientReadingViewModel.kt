...
class PatientReadingViewModel @ViewModelInject constructor(
    ...
    /**
     * Used in two-way Data Binding with PatientInfoFragment
     * @see com.cradleVSA.neptune.binding.Converter.sexToString
     */
     ...
     * recommended.
     *
     * @see com.cradleVSA.neptune.binding.ReadingBindingAdapters.addRecommendedToEndWhen
     */
     ...
     * @see com.cradleVSA.neptune.binding.ReadingBindingAdapters.setError
     */
