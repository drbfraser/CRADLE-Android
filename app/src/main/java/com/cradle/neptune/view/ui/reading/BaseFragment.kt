...
abstract class BaseFragment : Fragment() {
    ...
    protected var MASK_USER_HAS_SELECTED_THE_NO_SYMPTOM: Long = 0x0001
    protected var MASK_USER_HAS_CHANGED_FOLLOW_UP: Long = 0x0002
    protected var MASK_USER_HAS_CHANGED_RECHECK_OPTION: Long = 0x0004
