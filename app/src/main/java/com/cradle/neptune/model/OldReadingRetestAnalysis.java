...
//    private PatientReadingViewModel viewModel;
...
//     * Constructor
//     */
//    public ReadingRetestAnalysis(PatientReadingViewModel viewModel, ReadingManager manager, Context context) {
...
//        // load history
//        if (viewModel != null) {
//            for (String l : viewModel.getPreviousReadingIds()) {
...
//            analyses.add(r.getBloodPressure().getAnalysis());
//        }
//    }
//
