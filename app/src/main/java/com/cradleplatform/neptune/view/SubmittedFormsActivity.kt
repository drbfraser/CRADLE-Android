...
@AndroidEntryPoint
class SubmittedFormsActivity : AppCompatActivity() {
    ...
    private fun setUpSavedFormsRecyclerView() {
        lifecycleScope.launch {
            ...
            recyclerView.apply {
                addItemDecoration(
                    DividerItemDecoration(this@SubmittedFormsActivity, DividerItemDecoration.VERTICAL)
                )
    ...
    private fun setUpActionBar() {
        supportActionBar?.title = getString(R.string.see_submitted_forms)
