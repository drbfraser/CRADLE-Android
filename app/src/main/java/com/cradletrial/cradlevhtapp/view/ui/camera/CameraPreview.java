package com.cradletrial.cradlevhtapp.view.ui.camera;
...
//            setMeasuredDimension((int) (width * ratio), height);
    ...
    private Camera.Size getOptimalPreviewSizeBasedOnWidth(List<Camera.Size> sizes, int w, int h) {
    ...
    private Camera.Size getOptimalPreviewSizeBasedOnHeight(List<Camera.Size> sizes, int w, int h) {
        final double ASPECT_TOLERANCE = 0.1;
        double targetRatio = (double) h / w;
